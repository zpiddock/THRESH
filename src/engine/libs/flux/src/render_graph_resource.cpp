...
namespace flux {
    ...
    auto usage_to_descriptor_type(ResourceUsage usage) -> VkDescriptorType {
        switch (usage) {
            case ResourceUsage::SampledImage:
            ...
            default:
                // Attachments, vertex/index buffers, transfer ops don't use descriptors
                return VK_DESCRIPTOR_TYPE_MAX_ENUM;
        }
    }

    auto usage_to_shader_stages(ResourceUsage usage) -> VkShaderStageFlags {
        switch (usage) {
            case ResourceUsage::SampledImage:
            case ResourceUsage::StorageImageRead:
            case ResourceUsage::StorageImageWrite:
            ...
            case ResourceUsage::StorageBufferWrite:
            case ResourceUsage::StorageBufferReadWrite:
                // Could be used in any shader stage - caller should narrow this if needed
