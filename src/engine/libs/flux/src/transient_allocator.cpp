...
namespace flux {
    ...
    auto TransientAllocator::allocate_image(
        ...
        image_info.imageType = desc.extent.depth > 1
                                   ? VK_IMAGE_TYPE_3D
        ...
        if (vk_result != VK_SUCCESS) {
            SUB_ERROR("Failed to allocate transient image: {}", static_cast<int>(vk_result));
        ...
        SUB_DEBUG("Allocated transient image: {}x{}x{}, format={}, passes=[{},{}]",
    ...
    auto TransientAllocator::allocate_buffer(
        ...
        if (vk_result != VK_SUCCESS) {
            SUB_ERROR("Failed to allocate transient buffer: {}", static_cast<int>(vk_result));
        ...
        SUB_DEBUG("Allocated transient buffer: {} bytes, passes=[{},{}]",
    ...
    auto TransientAllocator::create_image_view(
        ...
        if (result != VK_SUCCESS) {
            SUB_ERROR("Failed to create image view: {}", static_cast<int>(result));
