 ...
 */
    ...
    public:
        ...
        static auto log_trace(const std::source_location &location, const std::string &fmt,
        ...
        template<typename... Args>
        static auto log_debug(const std::source_location &location, const std::string &fmt,
                              const Args &... args) -> void {
            if constexpr (sizeof...(Args) > 0) {
        ...
        template<typename... Args>
        static auto log_info(const std::source_location &location, const std::string &fmt,
                             const Args &... args) -> void {
            if constexpr (sizeof...(Args) > 0) {
        ...
        template<typename... Args>
        static auto log_warn(const std::source_location &location, const std::string &fmt,
                             const Args &... args) -> void {
            if constexpr (sizeof...(Args) > 0) {
        ...
        template<typename... Args>
        static auto log_error(const std::source_location &location, const std::string &fmt,
                              const Args &... args) -> void {
            if constexpr (sizeof...(Args) > 0) {
        ...
        template<typename... Args>
        static auto log_fatal(const std::source_location &location, const std::string &fmt,
                              const Args &... args) -> void {
            if constexpr (sizeof...(Args) > 0) {
...
#define SUB_TRACE(...) ::substratum::Logger::log_trace(::std::source_location::current(), __VA_ARGS__)
#define SUB_DEBUG(...) ::substratum::Logger::log_debug(::std::source_location::current(), __VA_ARGS__)
#define SUB_INFO(...)  ::substratum::Logger::log_info(::std::source_location::current(), __VA_ARGS__)
#define SUB_WARN(...)  ::substratum::Logger::log_warn(::std::source_location::current(), __VA_ARGS__)
#define SUB_ERROR(...) ::substratum::Logger::log_error(::std::source_location::current(), __VA_ARGS__)
